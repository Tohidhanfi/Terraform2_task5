...
resource "aws_cloudwatch_dashboard" "strapi_dashboard" {
  dashboard_name = "Strapi-task12-ECS-Dashboard"
...
resource "aws_cloudwatch_metric_alarm" "ecs_cpu_high" {
  alarm_name          = "strapi-task12-ecs-cpu-high"
...
resource "aws_cloudwatch_metric_alarm" "ecs_memory_high" {
  alarm_name          = "strapi-task12-ecs-memory-high"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "ecs_task_count" {
  alarm_name          = "strapi-task12-ecs-task-count"
...
resource "aws_cloudwatch_metric_alarm" "alb_response_time" {
  alarm_name          = "strapi-task12-alb-response-time"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "alb_5xx_errors" {
  alarm_name          = "strapi-task12-alb-5xx-errors"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "rds_cpu_high" {
  alarm_name          = "strapi-task12-rds-cpu-high"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
  metric_name         = "CPUUtilization"
  namespace           = "AWS/RDS"
...
resource "aws_cloudwatch_metric_alarm" "rds_connections" {
  alarm_name          = "strapi-task12-rds-connections"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "application_health" {
  alarm_name          = "strapi-task12-application-health"
  comparison_operator = "GreaterThanThreshold"
