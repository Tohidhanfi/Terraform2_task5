  ...
  container_definitions = jsonencode([
    {
      ...
      logConfiguration = {
        logDriver = "awslogs",
        options = {
          awslogs-group         = "/ecs/tohid-task10-strapi",
